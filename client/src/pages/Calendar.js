...
export default function Calendar() {
  ...
  return (
    <div className="flex flex-col h-full px-8 pt-6">
      ...
      <div className="grid grid-cols-7 gap-2 border rounded p-4 bg-white shadow-sm">
        {days.map((day, idx) => (
          <div key={idx} className="flex flex-col w-full items-start">
            ...
            <div className="h-64 w-full bg-orange-200 rounded-md p-2 flex flex-col gap-3 overflow-y-auto text-left">
